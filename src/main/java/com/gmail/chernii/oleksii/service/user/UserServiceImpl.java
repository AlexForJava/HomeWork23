...
import com.gmail.chernii.oleksii.mappers.user.UserMapper;
...
public class UserServiceImpl implements UserService, UserServiceRegistration {
    ...
    public void create(UserDto userDto) {
        repository.save(mapper.create(userDto));
    }
    ...
    public void update(UserDto userDto) throws NotFoundUserException {
        ...
        repository.save(mapper.update(entity, userDto));
    }
    ...
    public UserDto findUserById(Long id) throws NotFoundUserException {
        return mapper.entityToDto(repository.findById(id).orElseThrow(NotFoundUserException::new));
    }
